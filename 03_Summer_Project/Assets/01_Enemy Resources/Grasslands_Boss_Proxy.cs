...
public class Grasslands_Boss_Proxy : MonoBehaviour, IConvertGameObjectToEntity, IDeclareReferencedPrefabs
{
...
#pragma warning restore 0649
	...
	public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
	{
		...
		dstManager.AddComponentData(entity, new Grasslands_Boss
		{
			PrimarySpellCooldown = 0,
			PrimarySpellDuration = 0,
			SpawnerTimer = 0,
		...
		dstManager.AddComponentData(entity, new CanShootLine());
